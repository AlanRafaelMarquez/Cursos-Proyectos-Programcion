...
public class Principal {
    ...
    public static void llenarPoligono(){
        ...
        do {
            do {
                System.out.println("Digita un poligono que deseas: ");
    ...
    public static void llenarTriangulo(){
        ...
        //Guardamos un trinagulo dentro del arreglo de poligonos
    ...
    public static void  llenarRectangulo(){
        ...
        System.out.println("\nDigita el lado 1 del rectangulo ");
        lado1 = entrada.nextDouble();
        System.out.println("\nDigita el lado 2 del rectangulo ");
        lado2 = entrada.nextDouble();
